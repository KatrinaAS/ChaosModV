...
private:
	...
	OptionsFile m_StreamFile{ "chaosmod/voting.ini" };
...
public:
	...
	template <typename T>
	inline T GetStreamValue(const std::string& szKey, T defaultValue)
	{
		return GetOptionValue(m_StreamFile, szKey, defaultValue);
	}
